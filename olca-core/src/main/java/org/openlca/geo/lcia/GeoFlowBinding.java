 ...
 */
public class GeoFlowBinding {

	public final Flow flow;
	public String formula;

	public GeoFlowBinding(Flow flow) {
		this.flow = flow;
		this.formula = "1";
	}

	public static GeoFlowBinding fromJson(JsonObject obj, IDatabase db) {
		if (obj == null || db == null)
			return null;
	 ...
	 */
	public Double defaultValueOf(Iterable<GeoProperty> properties) {
