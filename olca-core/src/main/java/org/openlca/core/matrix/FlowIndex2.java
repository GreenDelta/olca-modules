 ...
 */
public class FlowIndex2 extends DIndex<FlowDescriptor> {
	...
	public static FlowIndex2 build(
			MatrixCache cache,
	...
	private static class Builder {
		...
		FlowIndex2 build() {
			FlowIndex2 index = new FlowIndex2();
		...
		private void indexFlow(CalcExchange e, FlowIndex2 index) {
			if (index.contains(e.flowId))
				return;
			if (e.isInput) {
