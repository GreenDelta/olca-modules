...
public class CalculationSetup {
    ...
    /**
     * Optionally set another unit for the calculation than the one defined
    ...
    /**
     * Optionally set another flow property factor for the calculation than
     * the one defined in the product system.
     */
    ...
    /**
     * Optionally set another target amount for the calculation than
     * the one defined in the product system.
     */
