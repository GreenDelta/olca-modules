...
public final class Uncertainties {
	...
	private static void mapUniform(JsonObject json, Uncertainty u) {
		u.parameter1Value = Json.getOptionalDouble(json, "minimum");
		u.parameter2Value = Json.getOptionalDouble(json, "maximum");
	...
	private static void mapTriangle(JsonObject json, Uncertainty u) {
		u.parameter1Value = Json.getOptionalDouble(json, "minimum");
		u.parameter2Value = Json.getOptionalDouble(json, "mode");
		u.parameter3Value = Json.getOptionalDouble(json, "maximum");
		// TODO: set formulas (when parameter import ready)
		// u.setParameter1Formula(In.getString(json, "minimumFormula"));
	...
	private static void mapNormal(JsonObject json, Uncertainty u) {
		u.parameter1Value = Json.getOptionalDouble(json, "mean");
		u.parameter2Value = Json.getOptionalDouble(json, "sd");
		// TODO: set formulas (when parameter import ready)
	...
	private static void mapLogNormal(JsonObject json, Uncertainty u) {
		u.parameter1Value = Json.getOptionalDouble(json, "geomMean");
		u.parameter2Value = Json.getOptionalDouble(json, "geomSd");
		// TODO: set formulas (when parameter import ready)
