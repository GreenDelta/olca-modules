...
@XmlEnum
enum ImpactLanguageCode implements ILanguageCode {
    ...
    public static ImpactLanguageCode fromValue(String v) {
        for (ImpactLanguageCode c: ImpactLanguageCode.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
