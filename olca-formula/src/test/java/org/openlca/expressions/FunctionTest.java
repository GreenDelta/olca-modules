...
public class FunctionTest {
	...
	public void testSample1() throws Exception {
		interpreter.bind(new Variable("g2", "1"));
		interpreter.bind(new Variable("g3", "2"));
		interpreter.bind(new Variable("g4", "3"));
		interpreter.bind(new Variable("g5", "g3^4"));
		interpreter.bind(new Variable("g6", "g4-g2"));
		interpreter.bind(new Variable("g7", "g4/g3"));
	...
	public void testSample2() throws Exception {
		...
		interpreter.bind(new Variable("g3", "2"));
		interpreter.bind(new Variable("g4", "3"));
		interpreter.bind(new Variable("g8", "g4 div g3"));
		interpreter.bind(new Variable("g9", "(g2+g3+6) mod 2 "));
		interpreter.bind(new Variable("g10", "abs(-g4) "));
		interpreter.bind(new Variable("g11", "acos(-g2)"));
		assertEquals(1, interpreter.eval("g2"), 1e-20);
		assertEquals(2, interpreter.eval("g3"), 1e-20);
		assertEquals(3, interpreter.eval("g4"), 1e-20);
	...
	public void testSample3() throws Exception {
		interpreter.bind(new Variable("g5", "16"));
		interpreter.bind(new Variable("g6", "g5-2"));
		interpreter.bind(new Variable("g7", "g5/g5"));
		interpreter.bind(new Variable("g11", "acos(-1)"));
		interpreter
				.bind(new Variable("g50", "ln((0.2+5*10^-3)/(0.1-5*10^-3))"));
		interpreter.bind(new Variable("g51",
				"9.25+ln((0.2+5*10^-3)/(0.1-5*10^-3))"));
		assertEquals(16, interpreter.eval("g5"), 1e-20);
	...
	public void testSample4() throws Exception {
		interpreter.bind(new Variable("g12", "20.64159265"));
		interpreter.bind(new Variable("g13", "exp(g12)"));
		interpreter.bind(new Variable("g14", "log(g12)"));
	...
	public void testSample5() throws Exception {
		interpreter.bind(new Variable("g5", "16"));
		interpreter.bind(new Variable("g21", "sin(g5)"));
		interpreter.bind(new Variable("g22", "sqr(g5)"));
		interpreter.bind(new Variable("g23", "sqrt(256)"));
		interpreter.bind(new Variable("g28", "if(g5>10;g5;0)"));
		assertEquals(16, interpreter.eval("g5"), 1e-20);
