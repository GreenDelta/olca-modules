...
@XmlType(name = "TypeOfProcessValues", namespace = "http://www.ilcd-network.org/ILCD/ServiceAPI")
@XmlEnum
public enum TypeOfProcessValues {
	...
	public static TypeOfProcessValues fromValue(String v) {
		for (TypeOfProcessValues c : TypeOfProcessValues.values()) {
			if (c.value.equals(v)) {
				return c;
			}
		}
