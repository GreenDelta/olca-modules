 ...
 * 
 */
@XmlType(name = "MethodOfReviewValues", namespace = "http://www.ilcd-network.org/ILCD/ServiceAPI")
@XmlEnum
public enum MethodOfReviewValues {
    ...
    /**
     * Values in the inventory are re-calculated from the raw data, or other calculations are validated exemplarily, e.g. scaling, averaging, summing
    ...
    /**
     * The energy balance (e.g. gross or net calorific value or exergy) of the Inputs and Outputs is validated. [Note: For processes that have
     *                         undergone allocation or consequential modeling the value of this review method is limited.]
     * 
     */
    ...
    /**
     * The balance of the relevant chemical elements of the Inputs and Outputs is calculated and validated. The validated elements should be named in
     *                         the review comments. [Note: For processes that have undergone allocation or consequential modeling the value of this review method is
     *                         limited.]
     * 
     */
    ...
    /**
     * Comparison with similar process or product system from the same or from other sources (can be both database and
     *                         literature).
     * 
     */
    ...
    /**
     * Analysis by means of expert opinions. The expert(s) have methodological and detailed technical expertise on the item to be verified and the
    ...
    /**
     * The mass balance of the Inputs and Outputs is validated. [Note: For processes that have undergone allocation or consequential modeling the
    ...
    /**
     * Regulated Inputs and Outputs e.g. emission data are validated for compliance with legal limits, typically after relating and scaling the data
     *                         to the regulated processes/sites etc.
     * 
     */
    ...
    /**
     * Interviews and/or plant visits are performed to validate data and other informtion, tyically in case of inconsistencies, uncertainties, or
     *                         doubts. People interviewed have detailed technical expertise on the analysed process(es).
     * 
     */
