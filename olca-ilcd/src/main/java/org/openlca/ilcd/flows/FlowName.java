 ...
 *         &lt;element name="flowProperties" type="{http://lca.jrc.it/ILCD/Common}StringMultiLang" maxOccurs="100" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    protected List<Label> baseName;
    protected List<Label> treatmentStandardsRoutes;
    protected List<Label> mixAndLocationTypes;
    protected List<Label> flowProperties;
     ...
     * 
     */
    public List<Label> getTreatmentStandardsRoutes() {
     ...
     * 
     */
    public List<Label> getMixAndLocationTypes() {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the flowProperties property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFlowProperties().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Label> getFlowProperties() {
