    ...
    implements Serializable
{
    ...
    @XmlElement(namespace = "http://lca.jrc.it/ILCD/Common")
    protected DataSetReference referenceToRegistrationAuthority;
    @XmlElement(namespace = "http://lca.jrc.it/ILCD/Common")
    ...
    @XmlElement(namespace = "http://lca.jrc.it/ILCD/Common")
    protected List<DataSetReference> referenceToEntitiesWithExclusiveAccess;
    @XmlElement(namespace = "http://lca.jrc.it/ILCD/Common")
     ...
     *     
     */
    public DataSetReference getReferenceToRegistrationAuthority() {
     ...
     *     
     */
    public void setReferenceToRegistrationAuthority(DataSetReference value) {
     ...
     * 
     */
    public List<DataSetReference> getReferenceToEntitiesWithExclusiveAccess() {
        if (referenceToEntitiesWithExclusiveAccess == null) {
            referenceToEntitiesWithExclusiveAccess = new ArrayList<>();
        }
