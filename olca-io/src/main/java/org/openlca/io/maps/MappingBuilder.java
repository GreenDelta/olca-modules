...
public class MappingBuilder {
	...
	public <T extends IMappingContent> ImportMap<T> buildImportMapping(
			Class<T> contentType, String mappingType) {
		Gson gson = new Gson();
		ImportMap<T> map = new ImportMap<T>();
		// TODO update mapping contents
	...
	public <T extends IMappingContent> Map<String, T> buildExportMapping(
			Class<T> contentType, String mappingType) {
		Gson gson = new Gson();
